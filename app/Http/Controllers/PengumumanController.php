...
class PengumumanController extends Controller
{
    ...
    public function datapengumuman()
    {
        ...
        return view ('pengumuman.data-pengumuman-admin',['viewDataUser' => $dataUser,'viewData' => $data,'viewIdPendaftaran' => $dataid,'viewkursus' => $dataprod]);
    }
    ...
    public function updatepengumuman(Request $a, $id_pengumuman){
        //$dataUser = ProfileUsers::all();
        try{
            $kursus =  preg_replace("/[^0-9]/", "", $a->kursus);
            if($kursus == 0)
            {
                $kursus = null;
            }
