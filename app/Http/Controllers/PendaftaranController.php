...
class PendaftaranController extends Controller
{
    ...
    public function inputpendaftaran(){
        ...
        //return view ('pendaftaran.data-pendaftaran-input-admin',['viewDataJadwal' => $dataJadwal,'viewSekolah' => $dataSekolah,'viewkursus' => $dataprod]);
        return view ('pendaftaran.data-pendaftaran-input-admin',['viewSekolah' => $dataSekolah,'viewkursus' => $dataprod]);
    }
    ...
    public function simpanpendaftaran(Request $a)
    {
        ...
        //     'pil1.required' => 'kursus choice must be filled',
        //     'pil2.required' => 'kursus choice must be filled',
    ...
    public function editpendaftaran($id_pendaftaran)
    {
        ...
        //return view('pendaftaran.data-pendaftaran-edit-admin', ['viewDataJadwal' => $dataJadwal,'viewDataUser' => $dataUser,'viewData' => $data,'viewSekolah' => $dataSekolah,'viewkursus' => $dataprod]);
        return view('pendaftaran.data-pendaftaran-edit-admin', ['viewDataUser' => $dataUser,'viewData' => $data,'viewSekolah' => $dataSekolah,'viewkursus' => $dataprod]);
    }
    ...
    public function hapuspendaftaran($id_pendaftaran){
        try{
            ...
            $dataPengumuman = Pengumuman::where("id_pendaftaran",$id_pendaftaran)->first();
    ...
    public function detailpendaftaran($id_pendaftaran)
    {
        ...
        return view('pendaftaran.data-pendaftaran-detail', ['viewDataUser' => $dataUser,'viewDataPembayaran' => $datPembayaran,'viewData' => $data,'viewSekolah' => $dataSekolah,'viewkursus' => $dataprod]);
    }
    ...
    public function kartupendaftaran($id_pendaftaran)
    {
        ...
        $dataSekolah = Sekolah::all();
        $data = Pendaftaran::find($id_pendaftaran);
        return view('pendaftaran.data-pendaftaran-kartu-admin', ['viewDataUser' => $dataUser,'viewData' => $data,'viewSekolah' => $dataSekolah,'viewkursus' => $dataprod]);
    }
}
