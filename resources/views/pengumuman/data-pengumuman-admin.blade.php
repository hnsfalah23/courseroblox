                                ...
                                <tbody>
                                    ...
                                    @foreach ($viewData as $x)
                                        <tr>
                                            ...
                                            <td><a href="detail-registration/{{ $x->pendaftaran->id_pendaftaran }}">{{ $x->pendaftaran->nama_siswa }}</a></td>
                                            <td>
                                                        ...
                                                        <form action="update-announcement/{{ $x->id_pengumuman }}"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="default-select form-control wide"
                                                                    ...
                                                                    @endif
                                                                    <option value="{{ $x->pendaftaran->pil1 }}">Pilihan 1 : {{ $x->pendaftaran->pilihan1->nama_kursus }}</option>
