                        ...
                        <div class="row">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-4 col-4">
                                    ...
                                    <div class="col-sm-9 col-7">
                                        <h5 class="f-w-500">{{ $viewData->tahun_masuk }}</h5>
                                    </div>
                                </div>
                                <div class="col-sm-4 col-4">
                                    <h5 class="f-w-400">Pilihan 1</h5>
                                    <div class="col-sm-9 col-7">
                                        <h5 class="f-w-500">{{ $viewData->pilihan1->nama_kursus }}</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="pt-4 border-bottom-1 pb-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-6 col-6">
                                    <h5 class="f-w-400">Nilai Raport</small></h5>
                                    <div class="col-sm-9 col-7">
                                        <a href="{{ asset($viewData->berkas_siswa) }}"> <i class="fa fa-file-pdf" style="font-size:48px;color:red"></i></a>
                                    </div>
                                </div>
