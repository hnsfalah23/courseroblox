                                ...
                                <a class="nav-link" href="javascript:void(0);" role="button"
                                    ...
                                    @if (auth()->user()->profile->foto != null)
                                        <img class="avatar-lg rounded-circle img-thumbnail"
                                            src="{{ url('/' . auth()->user()->profile->foto) }}" alt=""
                                            width="50px" />
                                    @else
                                        <img class="avatar-lg rounded-circle img-thumbnail"
        ...
        <div class="dlabnav">
            ...
            <div class="dlabnav-scroll">
                @auth
                    <div class="text-center sidebar-user">
                        ...
                        <a href="{{ route('profile') }}">
                            ...
                            @else
                                <img class="avatar-lg rounded-circle img-thumbnail"
                                    src="{{ asset('sipenmaru/images/ava.png') }}" alt="" width="75px" />
                            @endif
                ...
                <div class="copyright">
                    ...
                    <p class="fs-12">Made with <span class="heart"></span> by Muhammad Hans Falah</p>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright ©
                    ...
                    Designed &amp; Developed by <a href="https://www.instagram.com/muhammadhnsflah/"
                        target="_blank">Muhammad Hans Falah</a>
